    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("This is the second test remote sensor and it is connected via ETHERNET");
          client.println("<br />");
          client.println("\t It is the first assembled (ie <i>no breadboard</i>) prototype");
          client.println("<br />");
          client.println(" ");
          client.println("<br />");
